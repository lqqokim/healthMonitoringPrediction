...
public class SchedulerJobServiceImpl implements SchedulerJobService {
    ...
    public boolean scheduleOneTimeJob(String jobName, Class<? extends QuartzJobBean> jobClass, Date date) {
        ...
        try {
            ...
            log.debug("Job with key jobKey :" + jobKey + " and group :" + groupKey + " scheduled successfully for date :" + dt);
            return true;
        } catch (SchedulerException e) {
            log.debug("SchedulerException while scheduling job with key :" + jobKey + " message :" + e.getMessage());
        }
    ...
    public boolean updateOneTimeJob(String jobName, Date date) {
        ...
        try {
            ...
            log.debug("SchedulerException while updating one time job with key :" + jobKey + " message :" + e.getMessage());
            e.printStackTrace();
            return false;
        }
    }
    ...
    public boolean updateCronJob(String jobName, Date date, String cronExpression) {
        ...
        try {
            ...
            log.debug("SchedulerException while updating cron job with key :" + jobKey + " message :" + e.getMessage());
            e.printStackTrace();
            return false;
        }
    }
    ...
    public boolean unScheduleJob(String jobName) {
        ...
        try {
            ...
            log.debug("SchedulerException while unscheduling job with key :" + jobKey + " message :" + e.getMessage());
            e.printStackTrace();
            return false;
        }
    }
    ...
    public boolean deleteJob(String jobName) {
        ...
        try {
            ...
            log.debug("SchedulerException while deleting job with key :" + jobKey + " message :" + e.getMessage());
            e.printStackTrace();
            return false;
        }
    }
    ...
    public boolean pauseJob(String jobName) {
        ...
        String groupKey = "SampleGroup";
        JobKey jkey = new JobKey(jobKey, groupKey);
        log.debug("Parameters received for pausing job : jobKey :" + jobKey + ", groupKey :" + groupKey);
        ...
        try {
            ...
            log.debug("SchedulerException while pausing job with key :" + jobName + " message :" + e.getMessage());
            e.printStackTrace();
            return false;
        }
    }
    ...
    public boolean resumeJob(String jobName) {
        ...
        try {
            ...
            log.debug("SchedulerException while resuming job with key :" + jobKey + " message :" + e.getMessage());
            e.printStackTrace();
            return false;
        }
    }
    ...
    public boolean startJobNow(String jobName) {
        ...
        try {
            ...
            log.debug("SchedulerException while starting job now with key :" + jobKey + " message :" + e.getMessage());
            e.printStackTrace();
            return false;
        }
    }
    ...
    public boolean isJobRunning(String jobName) {
        ...
        try {
            ...
            log.debug("SchedulerException while checking job with key :" + jobKey + " is running. error message :" + e.getMessage());
            e.printStackTrace();
            return false;
        }
        return false;
    ...
    public List<Map<String, Object>> getAllJobs() {
        ...
        try {
            ...
            log.debug("SchedulerException while fetching all jobs. error message :" + e.getMessage());
            e.printStackTrace();
        }
        return list;
    }
    ...
    public boolean isJobWithNamePresent(String jobName) {
        try {
            ...
            log.debug("SchedulerException while checking job with name and group exist:" + e.getMessage());
            e.printStackTrace();
        }
        return false;
    }
    ...
    public boolean stopJob(String jobName) {
        ...
        try {
            ...
            log.debug("SchedulerException while stopping job. error message :" + e.getMessage());
            e.printStackTrace();
        }
        return false;
    }
