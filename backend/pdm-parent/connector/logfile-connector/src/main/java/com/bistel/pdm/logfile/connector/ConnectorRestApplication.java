...
/**
 *  The single JAX-RS app for the connector.
 *
 */
@ApplicationPath("")
public class ConnectorRestApplication extends Application {
    private static final Logger log = LoggerFactory.getLogger(ConnectorRestApplication.class);
    ...
    private Set<Class<?>> doGetClasses() {
        String packages = "com.bistel.pdm.logfile.connector.rest";
