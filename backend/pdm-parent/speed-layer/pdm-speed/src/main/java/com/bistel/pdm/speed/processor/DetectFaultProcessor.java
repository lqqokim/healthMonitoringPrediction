...
//        // time, P1, P2, P3, P4, ... Pn, status:time, groupid, refresh flag
...
//                intervalLongTime.put(partitionKey, Long.parseLong(statusCodeAndLongTime[1]));
//            }
//
//            // idle -> run
...
//
//            // processing
//            if (statusCodeAndLongTime[0].equalsIgnoreCase("RR")) {
//
...
//
//            // run -> idle
//            if (statusCodeAndLongTime[0].equalsIgnoreCase("RI")) {
//
//                Long startTime = intervalLongTime.get(partitionKey);
//                Long endTime = Long.parseLong(statusCodeAndLongTime[1]);
//
