 ...
 *
 */
public class SpeedTempCompressionTask extends AbstractPipeline {
    private static final Logger log = LoggerFactory.getLogger(SpeedTempCompressionTask.class);

    private final String applicationId;
    private final int streamThreadCount;
    private final String stateDir;

    public SpeedTempCompressionTask(String applicationId, String brokers, String servingAddr,
...
//                .addSink("output-event", this.getOutputEventTopic(), "timeout");
