...
import com.bistel.pdm.datastore.jdbc.dao.oracle.FeatureTrxDao;
import com.bistel.pdm.datastore.jdbc.dao.postgres.FeatureTrxPostgreDao;
...
public class FeatureConsumerRunnable implements Runnable {
    ...
    public FeatureConsumerRunnable(String configPath, String groupId, String topicName) {
