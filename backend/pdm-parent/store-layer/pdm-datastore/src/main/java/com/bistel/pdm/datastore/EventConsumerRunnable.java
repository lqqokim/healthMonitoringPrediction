...
import com.bistel.pdm.datastore.jdbc.dao.oracle.EventTrxDao;
import com.bistel.pdm.datastore.jdbc.dao.postgres.EventTrxPostgreDao;
...
public class EventConsumerRunnable implements Runnable {
    ...
    public EventConsumerRunnable(String configPath, String groupId, String topicName) {
