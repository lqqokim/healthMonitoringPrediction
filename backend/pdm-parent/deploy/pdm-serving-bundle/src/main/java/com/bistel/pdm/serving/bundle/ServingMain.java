 ...
 *
 */
public final class ServingMain {
    private final static Logger log = LoggerFactory.getLogger(ServingMain.class);
    ...
    public static void main(String[] args) throws Exception {
        ...
        log.info("e.g.> curl -X GET http://localhost:28000/pdm/api/master/latest ");
