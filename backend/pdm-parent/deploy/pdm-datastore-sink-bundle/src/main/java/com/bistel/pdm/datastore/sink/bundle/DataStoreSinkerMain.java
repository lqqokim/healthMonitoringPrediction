package com.bistel.pdm.datastore.sink.bundle;
 ...
 *
 */
public class DataStoreSinkerMain {
    private final static Logger log = LoggerFactory.getLogger(DataStoreSinkerMain.class);
    ...
    public static void main(String[] args) {
        try {
            ...
            RepositorySinker server = new RepositorySinker(groupId, topicPrefix, configPath);
            server.start();
    ...
    private static CommandLine parseCommandLine(String[] args) {
        ...
        options.addOption(groupId).addOption(topicPrefix).addOption(config).addOption(logPath);
