...
ALTER TABLE TRACE_RAW_TRX_PDM MODIFY ( MAX_FREQ         REAL );
ALTER TABLE TRACE_RAW_TRX_PDM MODIFY ( RPM              REAL );
ALTER TABLE TRACE_RAW_TRX_PDM MODIFY ( SAMPLING_TIME    REAL );
