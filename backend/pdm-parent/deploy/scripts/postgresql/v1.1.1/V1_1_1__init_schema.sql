...
ALTER TABLE EQP_MST_PDM ADD COLUMN MODEL_NAME VARCHAR(32);

ALTER TABLE EQP_EVENT_MST_PDM ADD COLUMN TIMEOUT INTEGER;

ALTER TABLE TRACE_TRX_PDM ADD COLUMN MESSAGE_GROUP VARCHAR(1024);
ALTER TABLE PARAM_FEATURE_TRX_PDM ADD COLUMN MESSAGE_GROUP VARCHAR(1024);
ALTER TABLE PARAM_HEALTH_TRX_PDM ADD COLUMN MESSAGE_GROUP VARCHAR(1024);

ALTER TABLE ALARM_TRX_PDM ADD COLUMN RULE_NAME VARCHAR(32);
ALTER TABLE ALARM_TRX_PDM ADD COLUMN CONDITION TEXT;

ALTER TABLE TRACE_TRX_PDM ADD COLUMN RULE_NAME VARCHAR(32);
ALTER TABLE TRACE_TRX_PDM ADD COLUMN CONDITION TEXT;

ALTER TABLE PARAM_MST_PDM ADD COLUMN DATA_TYPE VARCHAR(32);
ALTER TABLE PARAM_MST_PDM ALTER COLUMN DATA_TYPE SET DEFAULT 'CONTINUOUS';

--ALTER TABLE TRACE_RAW_TRX_PDM ALTER COLUMN MAX_FREQ REAL;
--ALTER TABLE TRACE_RAW_TRX_PDM ALTER COLUMN RPM REAL;
--ALTER TABLE TRACE_RAW_TRX_PDM ALTER COLUMN SAMPLING_TIME REAL;
