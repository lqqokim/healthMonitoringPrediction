...
--CREATE SEQUENCE seq_rule_window_trx_pdm
--  START WITH 1
--  INCREMENT BY 1
--  NO MINVALUE
--  NO MAXVALUE
...
CREATE UNIQUE INDEX UK_ALARM_TRX_PDM ON ALARM_TRX_PDM (ALARM_DTTS, PARAM_MST_RAWID, HEALTH_LOGIC_MST_RAWID);
...
--  RAWID                   INTEGER NOT NULL DEFAULT nextval('seq_rule_window_trx_pdm'),
--  PARAM_MST_RAWID         INTEGER NOT NULL,
--  START_WINDOW            INTEGER NULL,
--  END_WINDOW              INTEGER NULL,
--  ALARM_DTTS              TIMESTAMP DEFAULT CURRENT_TIMESTAMP
--);
--
--ALTER SEQUENCE seq_rule_window_trx_pdm OWNED BY RULE_WINDOW_TRX_PDM.RAWID;
--
