...
(
    ...
    PARSE_INDEX        smallint        DEFAULT -1,
...
(
    ...
    ALARM_TYPE_CD           character varying(32)   NOT NULL,
    VALUE                   REAL                    NOT NULL,
    FAULT_CLASS             character varying(1024) DEFAULT 'N/A',
    ALARM_SPEC              REAL                    NULL,
    WARNING_SPEC            REAL                    NULL,
...
CREATE TABLE EQP_EVENT_MST_PDM (
  RAWID             INTEGER NOT NULL DEFAULT nextval('seq_eqp_event_mst_pdm'),
  EQP_MST_RAWID     INTEGER NOT NULL,
...
ALTER SEQUENCE seq_eqp_event_mst_pdm OWNED BY EQP_EVENT_MST_PDM.RAWID;
...
CREATE TABLE EQP_EVENT_TRX_PDM (
  RAWID                   INTEGER NOT NULL DEFAULT nextval('seq_eqp_event_trx_pdm'),
  EQP_EVENT_MST_RAWID     INTEGER NOT NULL,
  EVENT_TYPE_CD           CHAR(1),
  EVENT_DTTS              TIMESTAMP DEFAULT CURRENT_TIMESTAMP
);

ALTER SEQUENCE seq_eqp_event_trx_pdm OWNED BY EQP_EVENT_TRX_PDM.RAWID;
...
ALTER SEQUENCE seq_eqp_alarm_daily_sum_pdm OWNED BY EQP_ALARM_DAILY_SUM_PDM.RAWID;

CREATE UNIQUE INDEX PK_EQP_ALARM_DAILY_SUM_PDM ON EQP_ALARM_DAILY_SUM_PDM (RAWID);
CREATE UNIQUE INDEX UK_EQP_ALARM_DAILY_SUM_PDM ON EQP_ALARM_DAILY_SUM_PDM (SUM_DTTS, EQP_MST_RAWID);
...
CREATE TABLE MONITORING_MST_PDM(
	...
	IMAGE         TEXT,
	DATAS         TEXT,
	WIDTH         numeric(10,0) NOT NULL,
	HEIGHT        numeric(10,0) NOT NULL,
