...
-- -----------------------------------------------------
-- Table EQP_TRACE_TRX_PDM
-- -----------------------------------------------------
CREATE SEQUENCE seq_eqp_trace_trx_pdm
       INCREMENT BY 1
       NOMINVALUE
       NOMAXVALUE
       CACHE 20
...
-- -----------------------------------------------------
-- Table PARAM_FAULT_TRX_PDM
-- -----------------------------------------------------
CREATE SEQUENCE seq_param_fault_trx_pdm
       INCREMENT BY 1
       NOMINVALUE
       NOMAXVALUE
       CACHE 20
...
CREATE TABLE PARAM_FAULT_TRX_PDM (
  RAWID                     NUMBER(38)          NOT NULL,
  PARAM_MST_RAWID           NUMBER(38)          NOT NULL,
...
CREATE UNIQUE INDEX PK_PARAM_FAULT_TRX_PDM ON PARAM_FAULT_TRX_PDM (RAWID) TABLESPACE NPDM_IDX;
CREATE UNIQUE INDEX UK_PARAM_FAULT_TRX_PDM ON PARAM_FAULT_TRX_PDM (FAULT_DTTS, PARAM_MST_RAWID, PARAM_HEALTH_MST_RAWID) TABLESPACE NPDM_IDX;
...
CREATE UNIQUE INDEX UK_EQP_EVENT_MST_PDM ON EQP_EVENT_MST_PDM (EQP_MST_RAWID, EVENT_NAME) TABLESPACE NPDM_IDX;
...
---- -----------------------------------------------------
--CREATE SEQUENCE seq_fault_smtp_cfg_pdm
--       INCREMENT BY 1
--       NOMINVALUE
--       NOMAXVALUE
--       CACHE 20
...
--       NOORDER;
--
--CREATE TABLE FAULT_SMTP_CFG_PDM (
...
-- -----------------------------------------------------
CREATE SEQUENCE seq_eqp_fault_daily_sum_pdm
       INCREMENT BY 1
       NOMINVALUE
       NOMAXVALUE
       CACHE 20
...
CREATE TABLE EQP_FAULT_DAILY_SUM_PDM (
  RAWID           NUMBER(38)    NOT NULL,
  EQP_MST_RAWID   NUMBER(38)    NOT NULL,
  FAULT_TYPE_CD   CHAR(1)       NULL
  VALUE           FLOAT         NULL,
  SUM_DTTS        TIMESTAMP(6)  DEFAULT CURRENT_TIMESTAMP,
  CREATE_BY       VARCHAR2(32)  NULL,
...
CREATE UNIQUE INDEX PK_EQP_FAULT_DAILY_SUM_PDM ON EQP_FAULT_DAILY_SUM_PDM (RAWID) TABLESPACE NPDM_IDX;
CREATE UNIQUE INDEX UK_EQP_FAULT_DAILY_SUM_PDM ON EQP_FAULT_DAILY_SUM_PDM (SUM_DTTS, EQP_MST_RAWID, FAULT_TYPE_CD) TABLESPACE NPDM_IDX;
...
(
    ...
    VALUE           VARCHAR2(1024),
    PROCESS_GROUP   VARCHAR2(1024)
) TABLESPACE NPDM_DAT;

CREATE UNIQUE INDEX PK_PARAM_DIMENSION_TRX_PDM ON PARAM_DIMENSION_TRX_PDM (RAWID) TABLESPACE NPDM_IDX;
CREATE UNIQUE INDEX PK_PARAM_DIMENSION_TRX_PDM ON PARAM_DIMENSION_TRX_PDM (BEGIN_DTTS, PARAM_MST_RAWID) TABLESPACE NPDM_IDX;


-- -----------------------------------------------------
-- Table EQP_ALARM_MST_PDM
-- -----------------------------------------------------
CREATE SEQUENCE seq_eqp_alarm_mst_pdm
       INCREMENT BY 1
       NOMINVALUE
       NOMAXVALUE
       CACHE 20
...
CREATE TABLE EQP_ALARM_MST_PDM (
  RAWID                     NUMBER(38)          NOT NULL,
  EQP_MST_RAWID             NUMBER(38)          NOT NULL,
  ALARM_ID                  VARCHAR2(32)        NOT NULL,
  ALARM_CODE                VARCHAR2(32),
  ALAMR_TEXT                VARCHAR2(1024),
  CREATE_BY                 VARCHAR2(32)        NULL,
  CREATE_DTTS               TIMESTAMP           DEFAULT CURRENT_TIMESTAMP,
  UPDATE_BY                 VARCHAR2(32)        NULL,
  UPDATE_DTTS               TIMESTAMP           DEFAULT CURRENT_TIMESTAMP
...
CREATE UNIQUE INDEX PK_EQP_ALARM_MST_PDM ON EQP_ALARM_MST_PDM (RAWID) TABLESPACE NPDM_IDX;
CREATE UNIQUE INDEX UK_EQP_ALARM_MST_PDM ON EQP_ALARM_MST_PDM (EQP_MST_RAWID, ALARM_ID, ALARM_CODE) TABLESPACE NPDM_IDX;


-- -----------------------------------------------------
-- Table EQP_ALARM_TRX_PDM
-- -----------------------------------------------------
CREATE SEQUENCE seq_eqp_alarm_trx_pdm
       INCREMENT BY 1
       NOMINVALUE
       NOMAXVALUE
       CACHE 20
...
CREATE TABLE EQP_ALARM_TRX_PDM (
  RAWID                     NUMBER(38)          NOT NULL,
  EQP_ALARM_MST_RAWID       NUMBER(38)          NOT NULL,
  ALARM_ID                  VARCHAR2(32)        NOT NULL,
  ALARM_CODE                VARCHAR2(32),
  ALAMR_TEXT                VARCHAR2(1024),
  PROCESS_CONTEXT           VARCHAR2(32),
...
CREATE UNIQUE INDEX PK_EQP_ALARM_TRX_PDM ON EQP_ALARM_TRX_PDM (RAWID) TABLESPACE NPDM_IDX;
CREATE UNIQUE INDEX UK_EQP_ALARM_TRX_PDM ON EQP_ALARM_TRX_PDM (EQP_ALARM_MST_RAWID, ALARM_ID, ALARM_CODE) TABLESPACE NPDM_IDX;


-- -----------------------------------------------------
-- Table PROCESS_GROUP_MST_PDM
-- -----------------------------------------------------
CREATE SEQUENCE seq_process_group_mst_pdm
       INCREMENT BY 1
       NOMINVALUE
       NOMAXVALUE
       CACHE 20
...
CREATE TABLE PROCESS_GROUP_MST_PDM (
  RAWID                     NUMBER(38)          NOT NULL,
  EQP_MST_RAWID             NUMBER(38)          NOT NULL,
  PROCESS_GROUP_ID          VARCHAR2(64)        NOT NULL,
  GROUP_TYPE_CD             VARCHAR2(32)        DEFAULT 'PARAM',
  USE_YN                    CHAR(1)             DEFAULT 'Y',
  CREATE_BY                 VARCHAR2(32)        NULL,
  CREATE_DTTS               TIMESTAMP           DEFAULT CURRENT_TIMESTAMP,
  UPDATE_BY                 VARCHAR2(32)        NULL,
...
CREATE UNIQUE INDEX PK_PROCESS_GROUP_MST_PDM ON PROCESS_GROUP_MST_PDM (RAWID) TABLESPACE NPDM_IDX;
CREATE UNIQUE INDEX UK_PROCESS_GROUP_MST_PDM ON PROCESS_GROUP_MST_PDM (EQP_MST_RAWID, PROCESS_GROUP_ID) TABLESPACE NPDM_IDX;


-- -----------------------------------------------------
-- Table PARAM_GROUP_MST_PDM
-- -----------------------------------------------------
CREATE SEQUENCE seq_process_group_mst_pdm
       INCREMENT BY 1
       NOMINVALUE
...
CREATE TABLE PARAM_GROUP_MST_PDM (
  RAWID                     NUMBER(38)          NOT NULL,
  PROCESS_GROUP_MST_RAWID   NUMBER(38)          NOT NULL,
  PARAM_MST_RAWID           NUMBER(38)          NOT NULL,
  CONDITION                 VARCHAR2(4000)      NOT NULL,
  USE_TIMEOUT_YN            CHAR(1)             DEFAULT 'Y',
  TIMEOUT_MS                NUMBER(32)          DEFAULT 600000,
  USE_YN                    CHAR(1)             DEFAULT 'Y',
  CREATE_BY                 VARCHAR2(32)        NULL,
  CREATE_DTTS               TIMESTAMP           DEFAULT CURRENT_TIMESTAMP,
  UPDATE_BY                 VARCHAR2(32)        NULL,
...
CREATE UNIQUE INDEX PK_PARAM_GROUP_MST_PDM ON PARAM_GROUP_MST_PDM (RAWID) TABLESPACE NPDM_IDX;
CREATE UNIQUE INDEX UK_PARAM_GROUP_MST_PDM ON PARAM_GROUP_MST_PDM (PROCESS_GROUP_MST_RAWID, PARAM_MST_RAWID) TABLESPACE NPDM_IDX;

-- -----------------------------------------------------
-- Table EVENT_GROUP_MST_PDM
-- -----------------------------------------------------
CREATE SEQUENCE seq_event_group_mst_pdm
       INCREMENT BY 1
       NOMINVALUE
       NOMAXVALUE
       CACHE 20
...
CREATE TABLE EVENT_GROUP_MST_PDM (
  RAWID                     NUMBER(38)          NOT NULL,
  PROCESS_GROUP_MST_RAWID   NUMBER(38)          NOT NULL,
  START_EVENT_ID            VARCHAR2(32)        NOT NULL,
  END_EVENT_ID              VARCHAR2(32)        NOT NULL,
  USE_TIMEOUT_YN            CHAR(1)             DEFAULT 'Y',
  TIMEOUT_MS                NUMBER(32)          DEFAULT 600000,
  USE_YN                    CHAR(1)             DEFAULT 'Y',
  CREATE_BY                 VARCHAR2(32)        NULL,
...
CREATE UNIQUE INDEX PK_EVENT_GROUP_MST_PDM ON EVENT_GROUP_MST_PDM (RAWID) TABLESPACE NPDM_IDX;
CREATE UNIQUE INDEX UK_EVENT_GROUP_MST_PDM ON EVENT_GROUP_MST_PDM (PROCESS_GROUP_MST_RAWID, START_EVENT_ID) TABLESPACE NPDM_IDX;


-- -----------------------------------------------------
-- Table STATUS_GROUP_MST_PDM
-- -----------------------------------------------------
CREATE SEQUENCE seq_status_group_mst_pdm
       INCREMENT BY 1
       NOMINVALUE
       NOMAXVALUE
       CACHE 20
...
CREATE TABLE STATUS_GROUP_MST_PDM (
  RAWID                     NUMBER(38)          NOT NULL,
  PROCESS_GROUP_MST_RAWID   NUMBER(38)          NOT NULL,
  PARAM_MST_RAWID           NUMBER(38)          NOT NULL,
  USE_TIMEOUT_YN            CHAR(1)             DEFAULT 'Y',
...
CREATE UNIQUE INDEX PK_STATUS_GROUP_MST_PDM ON STATUS_GROUP_MST_PDM (RAWID) TABLESPACE NPDM_IDX;
CREATE UNIQUE INDEX UK_STATUS_GROUP_MST_PDM ON STATUS_GROUP_MST_PDM (PROCESS_GROUP_MST_RAWID, PARAM_MST_RAWID) TABLESPACE NPDM_IDX;


-- -----------------------------------------------------
-- Table PROCESS_GROUP_TRX_PDM
-- -----------------------------------------------------
CREATE SEQUENCE seq_process_group_trx_pdm
       INCREMENT BY 1
       NOMINVALUE
       NOMAXVALUE
       CACHE 20
...
CREATE TABLE PROCESS_GROUP_TRX_PDM (
  RAWID                     NUMBER(38)          NOT NULL,
  PROCESS_GROUP_MST_RAWID   NUMBER(38)          NOT NULL,
  PROCESS_CONTEXT           VARCHAR2(32)        NOT NULL,
  START_EVENT_NAME          VARCHAR2(128)       NOT NULL,
  END_EVENT_NAME            VARCHAR2(128)       NOT NULL,
  START_DTTS                TIMESTAMP           DEFAULT CURRENT_TIMESTAMP,
  END_DTTS                  TIMESTAMP           DEFAULT CURRENT_TIMESTAMP
)
TABLESPACE NPDM_DAT
PARTITION BY RANGE (END_DTTS)
   (PARTITION P_201712 VALUES LESS THAN (to_timestamp('201801', 'YYYYMM')),
...
CREATE UNIQUE INDEX PK_PROCESS_GROUP_TRX_PDM ON PROCESS_GROUP_TRX_PDM (RAWID) TABLESPACE NPDM_IDX;
CREATE UNIQUE INDEX UK_PROCESS_GROUP_TRX_PDM ON PROCESS_GROUP_TRX_PDM (START_DTTS, PROCESS_GROUP_MST_RAWID) TABLESPACE NPDM_IDX;
...
-- -----------------------------------------------------
-- Table DATA_SYNC_MST_PDM
-- -----------------------------------------------------
CREATE SEQUENCE seq_data_sync_mst_pdm
       INCREMENT BY 1
       NOMINVALUE
       NOMAXVALUE
       CACHE 20
...
CREATE TABLE DATA_SYNC_MST_PDM
(
    RAWID                   NUMBER(38)      NOT NULL,
    ...
    SID                     VARCHAR2(32)    NULL,
    SERVICE_NAME            VARCHAR2(32)    NULL,
    AUTO_SYNC_YN            CHAR(1)         DEFAULT 'N'
    CREATE_BY               VARCHAR2(32)    NULL,
    CREATE_DTTS             TIMESTAMP       DEFAULT CURRENT_TIMESTAMP,
    UPDATE_BY               VARCHAR2(32)    NULL,
    UPDATE_DTTS             TIMESTAMP       DEFAULT CURRENT_TIMESTAMP
...
CREATE UNIQUE INDEX PK_DATA_SYNC_MST_PDM ON DATA_SYNC_MST_PDM (RAWID) TABLESPACE NPDM_IDX;
CREATE UNIQUE INDEX UK_DATA_SYNC_MST_PDM ON DATA_SYNC_MST_PDM (DB_TYPE, IP, PORT, USER_NAME) TABLESPACE NPDM_IDX;

-- -----------------------------------------------------
-- Table EQP_SYNC_LINK_MST_PDM
-- -----------------------------------------------------
CREATE SEQUENCE seq_eqp_sync_link_mst_pdm
       INCREMENT BY 1
       NOMINVALUE
       NOMAXVALUE
       CACHE 20
...
CREATE TABLE EQP_SYNC_LINK_MST_PDM
(
    RAWID                   NUMBER(38)      NOT NULL,
    EQP_MST_RAWID           NUMBER(38)      NOT NULL,
    DATA_SYNC_MST_RAWID     NUMBER(38)      NOT NULL,
...
CREATE UNIQUE INDEX PK_EQP_SYNC_LINK_MST_PDM ON EQP_SYNC_LINK_MST_PDM (RAWID) TABLESPACE NPDM_IDX;
CREATE UNIQUE INDEX UK_EQP_SYNC_LINK_MST_PDM ON EQP_SYNC_LINK_MST_PDM (EQP_MST_RAWID, DATA_SYNC_MST_RAWID) TABLESPACE NPDM_IDX;

-- -----------------------------------------------------
-- Table ALARM_SYNC_LINK_MST_PDM
-- -----------------------------------------------------
CREATE SEQUENCE seq_alarm_sync_link_mst_pdm
       INCREMENT BY 1
       NOMINVALUE
       NOMAXVALUE
       CACHE 20
...
CREATE TABLE ALARM_SYNC_LINK_MST_PDM
(
    RAWID                   NUMBER(38)      NOT NULL,
    EQP_ALARM_MST_RAWID     NUMBER(38)      NOT NULL,
    DATA_SYNC_MST_RAWID     NUMBER(38)      NOT NULL,
...
CREATE UNIQUE INDEX PK_ALARM_SYNC_LINK_MST_PDM ON ALARM_SYNC_LINK_MST_PDM (RAWID) TABLESPACE NPDM_IDX;
CREATE UNIQUE INDEX UK_ALARM_SYNC_LINK_MST_PDM ON ALARM_SYNC_LINK_MST_PDM (EQP_ALARM_MST_RAWID, DATA_SYNC_MST_RAWID) TABLESPACE NPDM_IDX;


-- -----------------------------------------------------
-- Table PARAM_SYNC_LINK_MST_PDM
-- -----------------------------------------------------
CREATE SEQUENCE seq_param_sync_link_mst_pdm
       INCREMENT BY 1
       NOMINVALUE
       NOMAXVALUE
       CACHE 20
...
CREATE TABLE PARAM_SYNC_LINK_MST_PDM
(
    RAWID                   NUMBER(38)      NOT NULL,
    PARAM_MST_RAWID         NUMBER(38)      NOT NULL,
    DATA_SYNC_MST_RAWID     NUMBER(38)      NOT NULL,
...
CREATE UNIQUE INDEX PK_PARAM_SYNC_LINK_MST_PDM ON PARAM_SYNC_LINK_MST_PDM (RAWID) TABLESPACE NPDM_IDX;
CREATE UNIQUE INDEX UK_PARAM_SYNC_LINK_MST_PDM ON PARAM_SYNC_LINK_MST_PDM (PARAM_MST_RAWID, DATA_SYNC_MST_RAWID) TABLESPACE NPDM_IDX;
