...
CREATE TABLE CONDITIONAL_SPEC_MST_PDM (
  ...
  CONDITION_NAME    VARCHAR2(32) NOT NULL,
...
CREATE UNIQUE INDEX UK_CONDITIONAL_SPEC_MST_PDM ON CONDITIONAL_SPEC_MST_PDM (MODEL_NAME, CONDITION_NAME) TABLESPACE NPDM_IDX;
...
CREATE UNIQUE INDEX UK_MODEL_PARAM_SPEC_MST_PDM ON MODEL_PARAM_SPEC_MST_PDM (CONDITIONAL_SPEC_MST_RAWID, MODEL_NAME, PARAM_NAME) TABLESPACE NPDM_IDX;
