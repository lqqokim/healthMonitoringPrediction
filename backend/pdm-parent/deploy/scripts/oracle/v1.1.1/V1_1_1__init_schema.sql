...
--ALTER TABLE PARAM_MST_PDM ADD (MAPPING_DIMENSION VARCHAR2(32));
--ALTER TABLE PARAM_FEATURE_TRX_PDM ADD (RESERVED_COL1 VARCHAR2(1024 BYTE));
--ALTER TABLE PARAM_FEATURE_TRX_PDM ADD (RESERVED_COL2 VARCHAR2(1024 BYTE));
--ALTER TABLE PARAM_FEATURE_TRX_PDM ADD (RESERVED_COL3 VARCHAR2(1024 BYTE));
--ALTER TABLE PARAM_FEATURE_TRX_PDM ADD (RESERVED_COL4 VARCHAR2(1024 BYTE));
--ALTER TABLE PARAM_FEATURE_TRX_PDM ADD (RESERVED_COL5 VARCHAR2(1024 BYTE));
...
CREATE UNIQUE INDEX PK_PARAM_DIMENSION_TRX_PDM ON PARAM_DIMENSION_TRX_PDM (RAWID) TABLESPACE SFA_IDX;