...
ALTER TABLE EQP_EVENT_MST_PDM ADD (USE_HOLIDAY_YN VARCHAR2(1) DEFAULT 'N');
...
ALTER TABLE TRACE_RAW_TRX_PDM MODIFY ( MAX_FREQ         FLOAT );
ALTER TABLE TRACE_RAW_TRX_PDM MODIFY ( RPM              FLOAT );
ALTER TABLE TRACE_RAW_TRX_PDM MODIFY ( SAMPLING_TIME    FLOAT );


DROP INDEX UK_TRACE_TRX_PDM;
CREATE UNIQUE INDEX UK_TRACE_TRX_PDM_1 ON TRACE_TRX_PDM (EVENT_DTTS, PARAM_MST_RAWID, STATUS_CD) TABLESPACE NPDM_IDX;
