...
CREATE UNIQUE INDEX UK_PARAM_HEALTH_RUL_TRX_PDM ON PARAM_HEALTH_RUL_TRX_PDM (ALARM_DTTS, PARAM_HEALTH_TRX_RAWID) TABLESPACE NPDM_IDX;




CREATE SEQUENCE seq_alarm_byrule_trx_pdm
       INCREMENT BY 1
       NOMINVALUE
       NOMAXVALUE
       CACHE 20
...
CREATE TABLE ALARM_BYRULE_TRX_PDM (
  RAWID                   NUMBER(38) NOT NULL,
  ALARM_TRX_RAWID         NUMBER(38) NOT NULL,
...
CREATE UNIQUE INDEX PK_ALARM_BYRULE_TRX_PDM ON ALARM_BYRULE_TRX_PDM (RAWID) TABLESPACE NPDM_IDX;
CREATE UNIQUE INDEX UK_ALARM_BYRULE_TRX_PDM ON ALARM_BYRULE_TRX_PDM (ALARM_DTTS, ALARM_TRX_RAWID) TABLESPACE NPDM_IDX;
