 ...
 */
export const location_model_param = (newConfig: FormConfigType = {}): FormConfigType => {
    return Util.Data.mergeDeep({
            ...
            initValuePromise: (formConfigType: FormConfigType, cloneWidgetModel: WidgetModel): Promise<any> => {
                ...
                return configAppModel.getLocationTypes().then((locationTypes) => {
                    ...
                    formConfigType.config.selectedValue = {
                        ...
                        [CD.TOOL_MODEL]: cloneWidgetModel.properties[CD.TOOL_MODEL],
                        [CD.TOOLS]: cloneWidgetModel.properties[CD.TOOLS],
                        [CD.EXCLUDE_PARAMETERS]: cloneWidgetModel.properties[CD.EXCLUDE_PARAMETERS]
                    };
                    // set locatoin function based on AJAX
                    formConfigType.config.setItem = ({key, item}) => {
                        cloneWidgetModel.properties[key] = item[CD.LOCATION];
                        cloneWidgetModel.properties[CD.TOOL_MODEL] = item[CD.TOOL_MODEL];
                        cloneWidgetModel.properties[CD.TOOLS] = item[CD.TOOLS];
                        cloneWidgetModel.properties[CD.EXCLUDE_PARAMETERS] = item[CD.EXCLUDE_PARAMETERS];
                    }
        ...
        config: {
            title: 'empty',
            isToolModelEnable: true,
            isToolsEnable: true,
            isExcludeParamsEnable: true,
