...
(function($) {
    ...
    // 상수로 높이값을 사용함
    var DATE_TIME_PICKER_HEIGHT = 290;
    ...
    DateTimePicker.prototype = {
        ...
        place: function(){
            ...
            if((offset.top + DATE_TIME_PICKER_HEIGHT) > document.documentElement.clientHeight) {
                // 달력이 윈도우 크기를 넘어가면 위쪽으로 보이게 한다. 달력의 높이 현재 290px
                offset.top = offset.top - (DATE_TIME_PICKER_HEIGHT + 5);
            } else {
                // 달력이 밑으로 보인다.
    ...
    $.fn.datetimepicker = function ( option, val ) {
        ...
        this.each(function () {
            ...
            if (!data) {
                $this.data('datetimepicker', (pickerObject = data = new DateTimePicker(
    ...
    function getTemplate(timeIcon, pickDate, pickTime, is12Hours, showSeconds, collapse) {
        if (pickDate && pickTime) {
            return (
                ...
                '<ul>' +
                '<div class="timepicker-today" >today</div>' +
