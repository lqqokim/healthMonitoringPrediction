...
@Component({
    moduleId: module.id,
    selector: 'tool-group-modal',
    templateUrl: './tool-group-modal.html'
})
export class ToolGroupModalComponent implements OnInit, OnDestroy {
