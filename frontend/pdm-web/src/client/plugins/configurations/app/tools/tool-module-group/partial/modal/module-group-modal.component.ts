...
@Component({
    moduleId: module.id,
    selector: 'module-group-modal',
    templateUrl: './module-group-modal.html'
})
export class ModuleGroupModalComponent implements OnInit, OnDestroy {
        ...
        this._subscription = this.applier
            ...
            .subscribe((response) => {
                if (response.type === 'APPLIED') {
                    ...
                    alert('Failed apply ModuleGroup modal');
                }
            },
            (err) => {
