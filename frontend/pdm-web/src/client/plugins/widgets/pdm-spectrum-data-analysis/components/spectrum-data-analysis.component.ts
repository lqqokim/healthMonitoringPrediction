import { Component, ViewEncapsulation, ViewChild, OnDestroy, ElementRef, ChangeDetectorRef, AfterViewInit, Renderer2, Input, SimpleChanges } from '@angular/core';
...
@Component({
    ...
    styleUrls: ['spectrum-data-analysis.css'],
    providers: [PdmEqpParamAnalysisService, PdmCommonService],
    encapsulation: ViewEncapsulation.None
})
export class SpectrumDataAnalysisComponent implements OnDestroy, AfterViewInit {
