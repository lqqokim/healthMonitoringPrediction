...
@Component({
    moduleId: module.id,
    selector: 'pdm-bar-widget',
    templateUrl: 'pdm-bar-widget.html',
    styleUrls: ['pdm-bar-widget.css'],
    providers: [PdmRadarService],
    encapsulation: ViewEncapsulation.None
})
export class PdmBarWidgetComponent extends WidgetApi implements OnSetup, OnDestroy, AfterViewInit {
