...
@Component({
    moduleId: module.id,
    selector: 'pdm-realtime-param-trend',
    templateUrl: './pdm-realtime-param-trend.html',
    styleUrls: ['./pdm-realtime-param-trend.css'],
    encapsulation: ViewEncapsulation.None
})
export class PdmRealTimeParamTrendComponent extends WidgetApi implements OnSetup, OnDestroy {
