                ...
                FlexSheet.prototype.getCellValue = function (rowIndex, colIndex, formatted, sheet) {
                    ...
                    if (wjcCore.isPrimitive(cellVal)) {
                        if (formatted) {
                            ...
                            if (wjcCore.isInt(cellVal) && !col.format && !col.dataMap && !format) {
                        ...
                        if (formatted) {
                            if (wjcCore.isInt(cellVal.value) && !col.format && !col.dataMap && !format && !cellVal.format) {
                                cellVal = cellVal.value.toString();
                            }
                            else {
                                cellVal = cellVal.value != null ? wjcCore.Globalize.format(cellVal.value, format || cellVal.format || col.format) : '';
                            }
                        }
                        else {
