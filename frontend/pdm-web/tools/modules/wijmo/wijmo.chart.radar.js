System.register(["wijmo/wijmo.chart", "wijmo/wijmo", "wijmo/wijmo.chart.radar"], function (exports_1, context_1) {
    "use strict";
    ...
    var wjcChart, wjcCore, wjcSelf, RadarChartType, FlexRadar, FlexRadarSeries, FlexRadarAxis, _RadarLinePlotter, _RadarBarPlotter;
    return {
        setters: [
            function (wjcChart_1) {
                wjcChart = wjcChart_1;
        ...
        execute: function () {
            ...
            exports_1("RadarChartType", RadarChartType);
            FlexRadar = (function (_super) {
            ...
            exports_1("FlexRadar", FlexRadar);
            'use strict';
            FlexRadarSeries = (function (_super) {
            ...
            exports_1("FlexRadarSeries", FlexRadarSeries);
            'use strict';
            FlexRadarAxis = (function (_super) {
            ...
            exports_1("FlexRadarAxis", FlexRadarAxis);
            'use strict';
            _RadarLinePlotter = (function (_super) {
            ...
            exports_1("_RadarLinePlotter", _RadarLinePlotter);
            'use strict';
            _RadarBarPlotter = (function (_super) {
            ...
            exports_1("_RadarBarPlotter", _RadarBarPlotter);
        }
    };
});
