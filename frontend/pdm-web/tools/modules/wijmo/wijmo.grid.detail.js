System.register(["wijmo/wijmo.grid", "wijmo/wijmo", "wijmo/wijmo.grid.detail"], function (exports_1, context_1) {
    "use strict";
    ...
    var wjcGrid, wjcCore, wjcSelf, DetailVisibilityMode, FlexGridDetailProvider, DetailMergeManager, DetailRow;
    return {
        setters: [
            function (wjcGrid_1) {
                wjcGrid = wjcGrid_1;
        ...
        execute: function () {
            ...
            exports_1("DetailVisibilityMode", DetailVisibilityMode);
            FlexGridDetailProvider = (function () {
            ...
            exports_1("FlexGridDetailProvider", FlexGridDetailProvider);
            'use strict';
            DetailMergeManager = (function (_super) {
            ...
            exports_1("DetailMergeManager", DetailMergeManager);
            'use strict';
            DetailRow = (function (_super) {
