System.register(["wijmo/wijmo.chart", "wijmo/wijmo", "wijmo/wijmo.chart.analytics"], function (exports_1, context_1) {
    "use strict";
    ...
    var wjcChart, wjcCore, wjcSelf, TrendLineBase, MathHelper, TrendLineFitType, TrendLine, Calculator, TrendHelperBase, LinearHelper, LogHelper, ExpHelper, PowerHelper, LeastSquaresHelper, PolyHelper, FourierHelper, SimpleTrendHelper, MinXHelper, MinYHelper, MaxXHelper, MaxYHelper, AverageXHelper, AverageYHelper, TrendLineHelper, FunctionSeries, YFunctionSeries, ParametricFunctionSeries, MovingAverageType, MovingAverage, Waterfall, QuartileCalculation, BoxWhisker, _BoxPlot, ErrorAmount, ErrorBarEndStyle, ErrorBarDirection, ErrorBar;
    return {
        setters: [
            function (wjcChart_1) {
                wjcChart = wjcChart_1;
        ...
        execute: function () {
            ...
            exports_1("TrendLineBase", TrendLineBase);
            'use strict';
            MathHelper = (function () {
                function MathHelper() {
                }
            ...
            })(TrendLineFitType || (TrendLineFitType = {}));
            exports_1("TrendLineFitType", TrendLineFitType);
            TrendLine = (function (_super) {
            ...
            LeastSquaresHelper = (function (_super) {
            ...
            SimpleTrendHelper = (function (_super) {
            ...
            AverageXHelper = (function (_super) {
            ...
            AverageYHelper = (function (_super) {
            ...
            'use strict';
            FunctionSeries = (function (_super) {
            ...
            exports_1("FunctionSeries", FunctionSeries);
            YFunctionSeries = (function (_super) {
            ...
            exports_1("YFunctionSeries", YFunctionSeries);
            ParametricFunctionSeries = (function (_super) {
            ...
            exports_1("ParametricFunctionSeries", ParametricFunctionSeries);
            'use strict';
            ...
            exports_1("MovingAverageType", MovingAverageType);
            MovingAverage = (function (_super) {
            ...
            exports_1("MovingAverage", MovingAverage);
            'use strict';
            Waterfall = (function (_super) {
            ...
            exports_1("QuartileCalculation", QuartileCalculation);
            BoxWhisker = (function (_super) {
            ...
            exports_1("BoxWhisker", BoxWhisker);
            _BoxPlot = (function () {
            ...
            exports_1("ErrorBarDirection", ErrorBarDirection);
            ErrorBar = (function (_super) {
