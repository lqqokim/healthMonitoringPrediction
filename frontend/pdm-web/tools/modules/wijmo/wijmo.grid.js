    ...
    return {
        ...
        execute: function () {
            ...
            FlexGrid = (function (_super) {
                ...
                FlexGrid.prototype._setFocusNoScroll = function (cell) {
                    var sp = this.scrollPosition, st = cell.style, wid = st.width, hei = st.height;
                ...
                FlexGrid.prototype._wantsInput = function (e) {
                    return !this.activeEditor && this._isInputElement(e) &&
                        !e.classList.contains('wj-grid-ime');
                };
            ...
            GridPanel = (function () {
                ...
                GridPanel.prototype._renderCell = function (row, r, c, rng, state, ctr) {
                    ...
                    if (cell && state) {
                        //fix bug when ctrl+alt multi-selection 
                        //https://bcm.bistel.com:8443/browse/MIDFD-992
                        //by ysyun
                        //--- start ---
                        var g = this._g;
                        var selectionMode = g.selectionMode;
                        var rowCollection = this._rows[r];
                        var isRowSelected = rowCollection.isSelected;
                        // console.log('>> row selected:', isRowSelected);
                        // console.log('\tselectionMode:', selectionMode, ', g:', g);
                        // console.log('\tr:', r, ', c:', c, ', selState:', selState);
                        // console.log('\tcursor-selected:', selState == ss.Cursor, ', multi-selected:', selState == ss.Selected);
                        //wjcCore.toogleClass source
                        // if (addOrRemove == null) {
                        ...
                        // }
                        if (selState == ss.Cursor) {
                            /** e.g) selectionMode values in html of wijmo grid
                                ...
                                selectionMode value in NUMBER !!!
                            */
                            if (selectionMode === 5) {
                                if (isRowSelected) {
                                    wjcCore.addClass(cell, 'wj-state-selected');
                                } else if (!isRowSelected) {
                                    wjcCore.removeClass(cell, 'wj-state-selected');
                                }
                            } else {
                                // wjcCore.addClass(cell, 'wj-state-selected');
                ...
                CellFactory.prototype.updateCell = function (p, r, c, cell, rng, updateContent) {
                    ...
                    switch (selState) {
                        case SelectedState.Cursor:
                            // console.log('>> cursor r:', r, ', c:', c, ', single selState:', selState);
                            cl += ' wj-state-selected';
                            break;
                        case SelectedState.Selected:
                            // console.log('>> cursor r:', r, ', c:', c, ', multi selState:', selState);
            ...
            _KeyboardHandler = (function () {
                ...
                _KeyboardHandler.prototype._keydown = function (e) {
                    ...
                    var defaultPrevented = e.defaultPrevented && !(e.target instanceof HTMLInputElement);
                ...
                _ImeHandler.prototype._compositionstart = function () {
                    ...
                    if (g.activeEditor == null) {
                        ...
                        if (g.startEditing(false, sel.row, sel.col, false)) {
                            ...
                            var edt = g.activeEditor, zIndex = edt && edt.parentElement ? edt.parentElement.style.zIndex : '';
