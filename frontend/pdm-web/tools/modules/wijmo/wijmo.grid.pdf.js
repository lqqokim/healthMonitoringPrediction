System.register(["wijmo/wijmo.pdf", "wijmo/wijmo.grid", "wijmo/wijmo", "wijmo/wijmo.grid.pdf"], function (exports_1, context_1) {
    ...
    var wjcPdf, wjcGrid, wjcCore, wjcSelf, ScaleMode, ExportMode, PdfFormatItemEventArgs, globCell, FlexGridPdfConverter, FlexGridRenderer, FlexSheetRenderer, MultiRowRenderer, PivotGridRenderer, PanelSection, PanelSectionRenderer, CellRenderer, GetMergedRangeProxy, CellRangeExt, RowRange, PdfPageRowRange;
    return {
        setters: [
            function (wjcPdf_1) {
                wjcPdf = wjcPdf_1;
        ...
        execute: function () {
            ...
            PivotGridRenderer = (function (_super) {
