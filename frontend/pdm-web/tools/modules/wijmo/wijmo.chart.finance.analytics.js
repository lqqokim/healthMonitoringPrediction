System.register(["wijmo/wijmo", "wijmo/wijmo.chart", "wijmo/wijmo.chart.finance", "wijmo/wijmo.chart.finance.analytics"], function (exports_1, context_1) {
    "use strict";
    ...
    exports_1("_williamsR", _williamsR);
    ...
    exports_1("_bollingerBands", _bollingerBands);
    ...
    exports_1("_stochastic", _stochastic);
    var wjcCore, wjcChart, wjcChartFinance, wjcSelf, Fibonacci, FibonacciArcs, FibonacciFans, FibonacciTimeZones, OverlayIndicatorBase, SingleOverlayIndicatorBase, ATR, CCI, WilliamsR, MovingAverageType, Envelopes, BollingerBands, RSI, MacdBase, Macd, MacdHistogram, Stochastic;
    return {
        setters: [
            function (wjcCore_1) {
                wjcCore = wjcCore_1;
        ...
        execute: function () {
            ...
            exports_1("FibonacciArcs", FibonacciArcs);
            FibonacciFans = (function (_super) {
            ...
            exports_1("FibonacciFans", FibonacciFans);
            FibonacciTimeZones = (function (_super) {
            ...
            exports_1("FibonacciTimeZones", FibonacciTimeZones);
            "use strict";
            OverlayIndicatorBase = (function (_super) {
            ...
            exports_1("OverlayIndicatorBase", OverlayIndicatorBase);
            SingleOverlayIndicatorBase = (function (_super) {
            ...
            exports_1("SingleOverlayIndicatorBase", SingleOverlayIndicatorBase);
            "use strict";
            ATR = (function (_super) {
            ...
            exports_1("Envelopes", Envelopes);
            "use strict";
            BollingerBands = (function (_super) {
            ...
            exports_1("BollingerBands", BollingerBands);
            "use strict";
            RSI = (function (_super) {
            ...
            exports_1("MacdBase", MacdBase);
            Macd = (function (_super) {
            ...
            exports_1("MacdHistogram", MacdHistogram);
            "use strict";
            Stochastic = (function (_super) {
            ...
            exports_1("Stochastic", Stochastic);
        }
    };
});
