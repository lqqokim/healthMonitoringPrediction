        ...
        execute: function () {
            ...
            ListBox = (function (_super) {
                ...
                function ListBox(element, options) {
                    ...
                    _this.hostElement.setAttribute('role', 'listbox');
                    ...
                    switch (e.keyCode) {
                        ...
                        case wjcCore.Key.PageDown:
                            ...
                            if (this.selectedIndex > -1) {
                                var index_2 = this.selectedIndex, height = host.offsetHeight, offset = 0;
                                for (var i = index_2 + 1; i < this._cv.items.length; i++) {
                        ...
                        case wjcCore.Key.PageUp:
                            e.preventDefault();
                            if (this.selectedIndex > -1) {
                                var index_3 = this.selectedIndex, height = host.offsetHeight, offset = 0;
                                for (var i = index_3 - 1; i > 0; i--) {
                                    var itemHeight = children[i].scrollHeight;
                                    if (offset + itemHeight > height) {
                                        this.selectedIndex = i;
                                        break;
            ...
            ComboBox = (function (_super) {
                ...
                function ComboBox(element, options) {
                    ...
                    var ddId = wjcCore.getUniqueId(host.id + '_dropdown');
                    _this.dropDown.id = ddId;
                    host.setAttribute('aria-expanded', 'false');
                    host.setAttribute('aria-haspopup', 'true');
                    host.setAttribute('aria-owns', ddId);
                    _this._tbx.setAttribute('aria-controls', ddId);
                    _this._tbx.setAttribute('aria-autocomplete', 'both');
                    ...
                    if (_this._orgTag == 'SELECT') {
                        _this._lbx._populateSelectElement(host);
                    }
                ...
                ComboBox.prototype.onIsDroppedDownChanged = function (e) {
                    ...
                    this.hostElement.setAttribute('aria-expanded', this.isDroppedDown.toString());
                };
                ...
                ComboBox.prototype._keydown = function (e) {
                    ...
                    var defaultPrevented = e.defaultPrevented && !(e.target instanceof HTMLInputElement);
                    if (this.isReadOnly || defaultPrevented) {
                        return;
                    }
                    if (e.altKey) {
                        return;
            ...
            Menu = (function (_super) {
                ...
                function Menu(element, options) {
                    ...
                    _this.dropDown.setAttribute('role', 'menu');
                    _this.listBox.itemRole = 'menuitem';
                    _this._tbx.removeAttribute('aria-autocomplete');
