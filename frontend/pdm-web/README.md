...
Then, the commented snippet in `index.ts` must be uncommented to register the worker script as a service worker. -->

<!-- use pdm server -->
gulp serve.dev --proxy=http://192.168.8.36:8080/

gulp build.prod --base=/portal/ --env=prod --config-env=prod
